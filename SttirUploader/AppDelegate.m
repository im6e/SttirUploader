...
{
    _directoryObserver = [[[DirectoryObserver alloc]init] initWithDirectoryPath:dirPath];
}
...
- (NSURL *)applicationFilesDirectory
{
    ...
    return [appSupportURL URLByAppendingPathComponent:@"com.sttir.SttirUploader"];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SttirUploader" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"SttirUploader.storedata"];
...
{
    [_directoryObserver stopObserving];
